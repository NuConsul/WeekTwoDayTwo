...
public class Car implements Parcelable {
    ...
    public Car(String carMake, String carModel, String carYear, String carTitleStatus, String carColor, String carEngine, String isAuto) {
